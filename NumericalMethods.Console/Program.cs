...
ModuleBuilder mb = builder.DefineDynamicModule(name.Name);

TypeBuilder tb = mb.DefineType(
            "Temporary",
             TypeAttributes.Public, typeof(IInterface2));

Type[] parameterTypes = { typeof(IInterface1) };
ConstructorBuilder ctor = tb.DefineConstructor(
    MethodAttributes.Public,
    CallingConventions.Standard,
    parameterTypes);

var mapped = Adapter.Adaptive<IInterface1, IInterface2>(new Test());
