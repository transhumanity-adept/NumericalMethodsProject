...
//}
#endregion
#region Решение диф уравнений первого порядка 
...
IEnumerable<(double x, double y)> RungeKuttaMethods(string fun, double a, double b, double h, (double x, double y) conditions)
{
    SymbolicExpression function = SymbolicExpression.Parse(fun);
